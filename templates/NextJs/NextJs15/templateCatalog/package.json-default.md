{
  ...
  "scripts": {
    ...
    "lint:eslint:check": "eslint --no-error-on-unmatched-pattern --cache './src/**/*.+(js|jsx|ts|tsx)' --max-warnings 0",
    "lint:eslint:fix": "eslint --no-error-on-unmatched-pattern --cache './src/**/*.+(js|jsx|ts|tsx)' --fix",
