{
  ...
  "scripts": {
    ...
    "ℹ️ info:Linting": "ℹ️",
    "lint": "cross-env run-s lint:fix lint:check",
    "lint:check": "run-s lint:prettier:check lint:eslint:check lint:style:check",
    "lint:fix": "run-s lint:prettier:fix lint:eslint:fix lint:style:fix",
    "lint:prettier:check": "prettier --check './src/**/*.{js,jsx,ts,tsx,md,mdx,json}'",
    "lint:prettier:fix": "prettier --write './src/**/*.{js,jsx,ts,tsx,md,mdx,json}'",
    "lint:eslint:check": "eslint --no-error-on-unmatched-pattern './src/**/*.+(js|jsx|ts|tsx)'",
    "lint:eslint:fix": "eslint --no-error-on-unmatched-pattern './src/**/*.+(js|jsx|ts|tsx)' --fix",
    ...
    "husky:pre-push": "run-p test:typescript lint:check test:smoke",
