{
  ...
  "scripts": {
    ...
    "lint:eslint:check": "eslint --cache --cache-strategy content --cache-location .eslintcache/ './src/**/*.+(js|jsx|ts|tsx)' --max-warnings 0 --config eslint.config.mjs",
    "lint:eslint:check:strict": "eslint --cache --cache-strategy content --cache-location .eslintcache/ './src/**/*.+(js|jsx|ts|tsx)' --max-warnings 0 --config eslint.config.strict.mjs",
    "lint:eslint:fix": "eslint --cache --cache-strategy content --cache-location .eslintcache/ './src/**/*.+(js|jsx|ts|tsx)' --fix --config eslint.config.strict.mjs",
