{
  ...
  "scripts": {
    ...
    "ℹ️ info:Testing": "ℹ️",
    "test": "run-s test:unit test:components test:snapshot:generate test:smoke test:e2e",
    ...
    "test:snapshot:verify": "cross-env TEST_WITH_SNAPSHOTS=true node --experimental-vm-modules node_modules/jest/bin/jest.js --silent --passWithNoTests",
